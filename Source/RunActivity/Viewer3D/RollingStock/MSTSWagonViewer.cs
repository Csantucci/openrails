...
namespace Orts.Viewer3D.RollingStock
{
    public class MSTSWagonViewer : TrainCarViewer
    {
            ...
            : base(viewer, car)
        {
            ...
            LeftWindowFront.SetState(MSTSWagon.LeftWindowFrontState >= MSTSWagon.WindowState.Opening);
            RightWindowFront.SetState(MSTSWagon.RightWindowFrontState >= MSTSWagon.WindowState.Opening);
            LeftWindowRear.SetState(MSTSWagon.LeftWindowRearState >= MSTSWagon.WindowState.Opening);
            RightWindowRear.SetState(MSTSWagon.RightWindowRearState >= MSTSWagon.WindowState.Opening);
        ...
        public override void PrepareFrame(RenderFrame frame, ElapsedTime elapsedTime)
        {
            ...
            LeftWindowFront.UpdateState(MSTSWagon.LeftWindowFrontState >= MSTSWagon.WindowState.Opening, elapsedTime);
            RightWindowFront.UpdateState(MSTSWagon.RightWindowFrontState >= MSTSWagon.WindowState.Opening, elapsedTime);
            LeftWindowRear.UpdateState(MSTSWagon.LeftWindowRearState >= MSTSWagon.WindowState.Opening, elapsedTime);
            RightWindowRear.UpdateState(MSTSWagon.RightWindowRearState >= MSTSWagon.WindowState.Opening, elapsedTime);
