...
namespace Orts.Viewer3D
{
    ...
    public class SharedMaterialManager
    {
        ...
        {
            var materialKey = String.Format("{0}:{1}:{2}:{3}:{4}", materialName, materialUniqueId?.ToLower(), options, mipMapBias, (Effect)null);
    ...
    public class ScreenMaterial : SceneryMaterial
    {
        ...
        public override void Render(GraphicsDevice graphicsDevice, IEnumerable<RenderItem> renderItems, ref Matrix XNAViewMatrix, ref Matrix XNAProjectionMatrix)
        {
            if (ScreenRenderer != null)
            {
                ...
                ScreenRenderer.CabShaderControlView.SpriteBatch.Begin(); // Dummy Begin(), gets closed immediately
