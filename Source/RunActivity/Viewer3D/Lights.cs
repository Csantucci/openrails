...
namespace Orts.Viewer3D
{
    public class LightViewer
    {
        ...
        bool UpdateState()
        {
            ...
            // Headlight
			int newTrainHeadlight = !Car.Lights.IgnoredConditions[0] ? (Car.Train != null ? Car.Train.TrainType != Train.TRAINTYPE.STATIC ? leadLocomotiveCar != null ? leadLocomotiveCar.Headlight : 0 : 0 : 0) : 0;
            // Unit
            ...
            int newReverserState = !Car.Lights.IgnoredConditions[10] ? ((Car.Train?.MUDirection == Direction.N || Car.Train != null && Math.Abs(Car.Train.MUReverserPercent) < 10.0f) ? 0 : 
