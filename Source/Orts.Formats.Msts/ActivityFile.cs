...
namespace Orts.Formats.Msts
{
    ...
    public enum WeatherType { Clear = 0, Snow, Rain, Few, Cloudy, Desert, SnowStorm, Foggy, PartlyCloudy }
    public enum Difficulty  { Easy = 0, Medium, Hard }
    public enum EventType   { AllStops = 0, AssembleTrain, AssembleTrainAtLocation, DropOffWagonsAtLocation, PickUpPassengers,
