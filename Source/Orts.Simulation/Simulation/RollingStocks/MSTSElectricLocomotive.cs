...
namespace Orts.Simulation.RollingStocks
{
    ...
    public class MSTSElectricLocomotive : MSTSLocomotive
    {
        ...
        public override string GetDebugStatus()
        {
            ...
            //Simulator.Catalog.GetString("Circuit breaker"),
            status.AppendFormat("\t{0}\t\t", Simulator.Catalog.GetParticularString("CircuitBreaker", GetStringAttribute.GetPrettyName(ElectricPowerSupply.CircuitBreaker.State)));
            ...
            status.AppendFormat("{0}", Simulator.Catalog.GetParticularString("PowerSupply", GetStringAttribute.GetPrettyName(LocomotivePowerSupply.AuxiliaryPowerSupplyState)));
