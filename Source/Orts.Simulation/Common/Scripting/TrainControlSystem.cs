...
namespace ORTS.Scripting.Api
{
    public abstract class TrainControlSystem : AbstractTrainScriptClass
    {
        ...
        internal MSTSLocomotive Loco => Host.Locomotive;
        ...
        {
            Loco.LocomotivePowerSupply.HandleEventFromTcs(evt);
        }
        ...
        {
            Loco.LocomotivePowerSupply.HandleEventFromTcs(evt, id);
        }
        ...
        {
            Loco.LocomotivePowerSupply.HandleEventFromTcs(evt, message);
        }
